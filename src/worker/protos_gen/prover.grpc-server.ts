...
// tslint:disable
import { ProofResponse } from "./prover.js";
...
export interface IProverService extends grpc.UntypedServiceImplementation {
     ...
     */
    proveBatch: grpc.handleUnaryCall<ProofRequest, ProofResponse>;
}
/**
...
export const proverServiceDefinition: grpc.ServiceDefinition<IProverService> = {
    ...
    proveBatch: {
        ...
        requestStream: false,
        responseStream: false,
        responseDeserialize: bytes => ProofResponse.fromBinary(bytes),
        requestDeserialize: bytes => ProofRequest.fromBinary(bytes),
        responseSerialize: value => Buffer.from(ProofResponse.toBinary(value)),
